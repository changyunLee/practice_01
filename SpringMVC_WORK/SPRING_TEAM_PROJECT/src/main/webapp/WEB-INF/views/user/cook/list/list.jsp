	...
	$.ajax({
		...
		success:function(result){
			...
			var html = "<tr>"
			    ...
			    html += "<td><a href='/cookDetail.do?c_num="+list[i].c_num+"'>"+list[i].c_title+"</a></td>"
...
<div id="paging"></div>
			...
			<hr class="mb-4">
                <a href="/user_home.do"><button class="btn btn-secondary btn-lg btn-block" type="button">메인 페이지</button></a>
           			<br />           
				<a href="/cookInsert.do"><button class="btn btn-secondary btn-lg btn-block" type="button">레시피 쓰러가기</button></a>
            </div>
        </div>
