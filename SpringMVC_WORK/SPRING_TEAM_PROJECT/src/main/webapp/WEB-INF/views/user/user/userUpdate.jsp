        ...
        <div class="container">
            ...
            <div class="py-5 text-center">
                <h4>기존 회원정보</h4>
                 ...
                 <!-- 비밀번호 입력 수정 -->
                         <div class="mb-8">
                             ...
                             <input type="password" name="user_pw" id="userPassowrd" class="form-control" style="text-align: center;">
                 
                <!-- 이름 입력 수정-->
                         <div class="mb-3">
                             <label for="userName">이름</label>
                             <input type="text" name="user_name" class="form-control" id="userName" style="text-align: center;">

                 <!-- 나이 입력 수정-->
                         <div class="mb-3">
                            <label for="userAge">나이</label>
                            <input type="text" name="user_age" class="form-control" id="userAge" style="text-align: center;">
                            

                 <!-- 이메일 입력 수정 -->       
                        <div class="mb-3">
                            <label for="userEmail">Email</label>
                             <input type="email" class="form-control" id="userEmail" value="${vo.user_email }" name="user_email" style="text-align: center;">
                ...
                <hr class="mb-4">
                        ...
                        <a href="/user.do"><button class="btn btn-secondary btn-lg btn-block" type="button">취소하고 돌아가기</button></a>
        </div>
<!-- 		</form> -->
