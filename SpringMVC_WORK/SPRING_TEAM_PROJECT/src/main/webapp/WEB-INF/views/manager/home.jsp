...
<!--                   </li> -->
              <li class="nav-item">
                <a class="nav-link" href="/cookB_list.do">자취맨's 요리</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/manager_list.do">공지사항</a>
              </li>
            </ul>
...
<!--             </form> -->
            ...
            <ul class="navbar-nav mt-2 mt-md-0">
              <li class="nav-item">
                ...
                <a href="/user.do"><button class="btn btn-outline-warning" type="submit">userInfo</button>&nbsp;</a>
            ...
            <div class="carousel-item active">
              ...
              <div class="container">
                <div class="carousel-caption text-left">
                  ...
                  <p><a class="btn btn-lg btn-warning" href="/cookB_list.do">게시글 보러가기!</a></p>
                </div>
              </div>
            </div>
            ...
            <div class="carousel-item">
              ...
              <div class="container">
                <div class="carousel-caption text-right">
                  ...
                  <p><a class="btn btn-lg btn-warning" href="/manager_list.do">공지사항 보러가기</a></p>
                </div>
              </div>
            </div>
          </div>
...
<!--               <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
              ...
              <h2>요리 자취맨</h2>
              <p>오늘은 남은 재료로 피자어때?</p>
              <p><a class="btn btn-secondary" href="/cookB_list.do">오늘 요리보러가기 &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
<!--             <div class="col-lg-4"> -->
<!--               <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
...
<!--             </div>/.col-lg-4 -->
            ...
            <div class="col-lg-4">
<!--               <svg class="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> -->
      			<img class="bd-placeholder-img rounded-circle" src="../resources/공지원.png" width="180" height="180" alt="">
              <h2>자취맨 공지</h2>
              <p>공지를 지켜주지 않으면 삭제당한다?</p>
              <p><a class="btn btn-secondary" href="/manager_list.do">공지사항 보러가기 &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
          </div><!-- /.row -->
