...
<body>
 <div class="container">
     ...
     <form action="manager_insert.do" method="post">
                
                <div >
                    <label for="c_num text-left">글 번호
                    <input type="text" name="n_num" class="form-control" value="${max }" style="text-align: center;" readonly="readonly"></label>
                
                    <div class="mb-3">
                        <label for="c_writer">글쓴이
                        <input type="text" class="form-control" name="n_writer" value="${id}" readonly="readonly"style="text-align: center;"> </label> 
                 <!-- 아이디 입력 수정 -->
                        <div >
                 ...
                 <!-- 비밀번호 입력 수정 -->
                         <div class="mb-8">
                             ...
                             <textarea type="text" name="n_content" rows="20" cols="20"class="form-control"></textarea>


                <hr class="mb-4">
                        <button class="btn btn-secondary btn-lg btn-block" type="submit">레시피 등록</button><br />
  </form>
                        <a href="/manager_list.do"><button class="btn btn-secondary btn-lg btn-block" type="button">등록 취소</button></a>
            </div>
        </div>
