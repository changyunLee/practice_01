	...
	$.ajax({
		...
		success:function(result){
			...
			var html = "<tr>"
			    ...
			    html += "<td><a href='manager_detail.do?n_num="+list[i].n_num+"'>"+list[i].n_title+"</a></td>"
...
<!-- <a href="/manager_insert.do"> 공지추가 </a> -->
	...
	<tr>
		...
		<td class="mx-5 text-center">저자</td>
...
<hr class="mb-4">
				<a href="/manager_insert.do"><button class="btn btn-secondary btn-lg btn-block" type="button">공지사항 쓰러가기</button></a>
           			<br />           
...
<!-- <a href="/manager_home.do">메인페이지</a> -->
